        ...
        <div class="uk-width-expand@m">
            <div class="blox-card">
                ...
                <div class="blox-card-body">
                    ...
                    <div class="uk-overflow-auto">
                        ...
                        <tr>
                            ...
                            <td><a href='../courses.php?slug=" . $record['slug'] . "'>" . $record['slug'] . "</a></td>
                            <td>" . $record['title'] . "</td>
                            <td>" . $record['level'] . "</td>
                            <td>" . $record['duration'] . "</td>
                            <td>" . $record['type'] . "</td>
                            <td><a href='./edit_courses.php?id=" . $record['id'] . "'><i class='far fa-edit fa-fw'></i></a></td>
                            <td><a href='./delete_courses.php?id=" . $record['id'] . "'><i class='far fa-trash-alt' fa-fw></i></a></td>
                        </tr>
                    ";
                            }
                            ?>
                ...
                <div class="blox-card-footer">
                    <a class="btn btn-secondary btn-full" href="./add_courses.php" role="button">Opleiding aanmaken</a>
                </div>
            </div>
        </div>
